...
///////////////////////////////////////////////////////////////////////////
// 2019-10-30 Added communication with Zandloper widget
...
define(['dojo/_base/declare',
    ...
    function (declare, lang, html, array, baseFx, WidgetManager, Move,
        ...
        SpeedMenu, jimuUtils, moment, TimeProcesser, LayerProcesser, utils, throttle) {

        var clazz = declare([BaseWidget], {
            baseClass: 'jimu-widget-timesliderplus',
            clasName: 'esri.widgets.TimeSliderPlus',
            speedMenu: null,
            _showed: false,
            _timeHandles: null,
            layerInfosObj: null,
            ...
            startup: function () {
                ...
                if (this.fetchDataByName) {
                    this.fetchDataByName('Zandloper');
                }
            },
            ...
            onReceiveData: function (name, widgetId, data) {
                ...
                var currentExtentStartDate = moment(data.message, "DD-MM-YYYY");
                var currentExtentEndDate = moment(data.message, "DD-MM-YYYY");
                var fullExtentStartDate = moment(data.message, "DD-MM-YYYY");
                var fullExtentEndDate = moment(data.message, "DD-MM-YYYY");
                ...
                if (timeSliderProps) {
                    timeSliderProps.startTime = fullExtentStartDate.add(data.config.start, data.config.timeUnit).valueOf();
                    timeSliderProps.endTime = fullExtentEndDate.add(data.config.end, data.config.timeUnit).valueOf();
                    timeSliderProps.currentTimeExtent = [
                        currentExtentStartDate.valueOf(),
                        currentExtentEndDate.add(1, 'days').valueOf()
                    ];
